...
fun manipulateString(str: String, int: Int): String {
    ...
    val manipulateString = str.filter { it.isDigit() }
    val number = if (manipulateString.isNotEmpty()) manipulateString.toInt() else 1
    val resultNumber = number * int
    val resultString = if (manipulateString.isNotEmpty()) str.replace(manipulateString, "") else str

    return resultString + resultNumber
}
